...
object JoinData {
  def main(args: Array[String]): Unit = {
    ...
    // Sampe
    val fraction: Double = 0.00001
    val sampledMasterElevationDataFrame = masterElevationDataFrame.sample(withReplacement = false, fraction)

    // Step 1: Join DataFrames and Select Columns
    val joinedDataFrame = trainingSetDataFrame.join(
      sampledMasterElevationDataFrame,
    ...
    // Step 5: Save completed training_set_2 to HDFS
