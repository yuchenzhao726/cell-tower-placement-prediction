...
POP_FILE_PATH = "/user/gw2310_nyu_edu/bdad_proj/pop_cnt"
CELL_FILE_PATH = "/user/gw2310_nyu_edu/bdad_proj/cell_tower"
SAVE_FILE_PATH = "/user/gw2310_nyu_edu/bdad_proj/training_set_2"
...
result = spark.sql("""
            SELECT random_places.*, AVG(pop_table.pop_cnt) AS pop_cnt
            FROM random_places 
